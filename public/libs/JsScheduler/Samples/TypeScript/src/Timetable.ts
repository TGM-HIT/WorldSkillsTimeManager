...
namespace Timetable {
	...
	let reverseGrouping = document.getElementById("reverseGrouping") as HTMLInputElement;
	reverseGrouping.checked = calendar.timetableSettings.reverseGrouping;
	reverseGrouping.onchange = () => {
		calendar.timetableSettings.reverseGrouping = reverseGrouping.checked;
		reverseGrouping.checked = calendar.timetableSettings.reverseGrouping;
	}
