     ...
     <div>
        ...
        <p>
          ...
          <div style="margin-left: 2%;">
            <v-row>
              <a href="https://worldskills.org/" style="color: inherit;">Official WorldSkills Website</a>
            </v-row>
          </div>
        </p>
        <br>
        <p>
          ...
          <div style="margin-left: 2%;">
            <v-row>
              <v-col class="d-flex align-center justify-start flex-wrap" cols="auto" style="gap: 1%;">
